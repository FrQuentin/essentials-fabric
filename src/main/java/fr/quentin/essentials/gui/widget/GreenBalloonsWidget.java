...
public class GreenBalloonsWidget extends ClickableWidget {
    ...
    private static final Identifier TEXTURE_HIGHLIGHTED = Identifier.of(Essentials.MOD_ID, "textures/gui/sprites/widget/green_balloons_highlighted.png");
    private final int x;
    private final int y;

    public GreenBalloonsWidget(int x, int y, int width, int height) {
        super(x, y, width, height, Text.empty());
        this.x = x;
        this.y = y;

        MutableText tooltipText = Text.translatable("tooltip.essentials.balloons.green_balloons.line1").formatted(Formatting.GRAY)
                .append("\n")
                .append(Text.translatable("tooltip.essentials.balloons.green_balloons.line2").formatted(Formatting.GRAY))
                .append("\n\n")
